...
function preload() {
  ...
  Scene2.flower = [loadImage("images/scene2-flower1.png"),
                   loadImage("images/scene2-flower2.png"),
                   loadImage("images/scene2-flower3.png")];
  ...
  Scene4.money = [loadImage("images/scene4-money1.png"),
                  loadImage("images/scene4-money2.png"),
                  loadImage("images/scene4-money3.png")];
...
// scene 2 variables
var backgroundFrame = 0; // share between scene 2,3 and 4
...
function draw() {
  ...
  if (slider.value() < 100){ // first scene, when slider return a value less than 100
    ...
    textStyle(NORMAL);
    textAlign(CENTER);
    fill(0,0,0,127.5*sin(frameCount/20)+127.5);
    noStroke();
    text("Move and press the cursor to explore",400,48);
    ...
    // flower
    print (mouseX,mouseY);
    if (mouseOver(260,1334,609,height)){ //260,1334,609,height
      noFill();
      stroke(0);
      strokeWeight(3);
      ellipse(mouseX,mouseY,frameCount%50);
    ...
    display(flowerVisibility,Scene2.flower[backgroundFrame],
    ...
    // reminding user to go to the next page
    if (featherVisibility && scarVisibility && flowerVisibility){
      textSize(15);
      textFont("Courier New");
      textStyle(NORMAL);
      textAlign(CENTER);
      fill(0,0,0,127.5*sin(frameCount/20)+127.5);
      noStroke();
      text("Slide to go to the next page",400,48);
    }
...
function showScene4() {
  ...
  if (scene4MusicPlayed <= 2){
    image(Scene4.money[backgroundFrame],width/2,height/2,Scene4.money[0].width/2,Scene4.money[0].height/2);
  }
